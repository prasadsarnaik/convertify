...
const highlights = [
  {
    ...
    description: "Upload a PDF and get a clean Excel workbook in a minimal flow.",
  },
  {
    icon: Shield,
    title: "Secure processing",
    description: "Files are processed in your browser and never uploaded.",
  },
  {
    icon: FileCheck2,
    title: "Ready to edit",
    description: "Open the .xlsx in Excel, Sheets or Numbers and edit instantly.",
  },
];
...
const PdfToExcelTool = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      const conversionResult = await convertPdfToExcel(file.file);
  ...
  return (
    <div className="relative overflow-hidden bg-background pt-24">
      <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[34rem] overflow-hidden">
        <div className="absolute left-1/2 top-0 h-72 w-72 -translate-x-[130%] rounded-full bg-accent-green/12 blur-3xl" />
        <div className="absolute left-1/2 top-16 h-80 w-80 translate-x-[10%] rounded-full bg-accent-blue/10 blur-3xl" />
          ...
          <div className="grid items-start gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
            ...
            >
              ...
              <h1 className="mt-6 max-w-2xl text-4xl font-extrabold leading-tight text-foreground sm:text-5xl md:text-6xl">
                Turn PDF documents into editable Excel spreadsheets in one screen.
              </h1>

              <p className="mt-5 max-w-xl text-base leading-7 text-muted-foreground sm:text-lg">
                Convert PDFs into structured XLSX workbooks with one sheet per
                page. Upload, convert and download from the same panel — your
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {highlights.map((item, index) => (
                  ...
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-accent-green to-accent-blue text-primary-foreground">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 -z-10 rounded-[2rem] bg-gradient-to-br from-accent-green/10 via-transparent to-accent-blue/10 blur-2xl" />
              <div className="rounded-[2rem] border border-border bg-background/95 p-5 shadow-stage backdrop-blur sm:p-7">
                <div className="flex items-start justify-between gap-4 border-b border-border/80 pb-5">
                  <div>
                    <p className="text-sm font-semibold uppercase tracking-[0.18em] text-accent-green">
                      Workspace
                    </p>
                    ...
                    <p className="mt-2 text-sm leading-6 text-muted-foreground">
                      Upload one PDF, convert it, and download the final XLSX
                      from the same panel.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-card p-3 text-accent-green">
                      ...
                      {!file ? (
                        ...
                        >
                          ...
                          <div className="mt-5 flex flex-wrap items-center justify-center gap-2 text-xs text-muted-foreground">
                            <span className="rounded-full border border-border bg-background px-3 py-1.5">PDF</span>
                  ...
                  {stage === "processing" && (
                    ...
                    >
                      ...
                      <div className="mx-auto mt-6 h-1.5 max-w-sm overflow-hidden rounded-full bg-card">
                        <motion.div
                          className="h-full w-1/3 rounded-full bg-gradient-to-r from-accent-green to-accent-blue"
                          animate={{ x: ["-100%", "300%"] }}
          ...
          <div className="grid gap-6 md:grid-cols-[0.9fr_1.1fr] md:items-start">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold text-foreground">
                A clearer path from PDF upload to editable spreadsheet.
              </h2>
