                      ...
                      {!file ? (
                        ...
                        >
                          ...
                          <div className="mt-5 flex flex-wrap items-center justify-center gap-2 text-xs text-muted-foreground">
                            <span className="rounded-full border border-border bg-background px-3 py-1.5">XLSX</span>
                            <span className="rounded-full border border-border bg-background px-3 py-1.5">XLS</span>
                            <span className="rounded-full border border-border bg-background px-3 py-1.5">CSV</span>
