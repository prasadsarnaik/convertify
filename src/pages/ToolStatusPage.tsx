...
const tools: ToolStatus[] = [
  ...
  { name: "Edit PDF", slug: "edit-pdf", icon: Edit, category: "PDF", status: "working", notes: "Canvas-based editor with text/image overlays. Exports all pages." },
  { name: "Protect PDF", slug: "protect-pdf", icon: Lock, category: "PDF", status: "working", notes: "AES-256-GCM encryption via Web Crypto API. Decryptable via Unlock PDF." },
  { name: "Unlock PDF", slug: "unlock-pdf", icon: Unlock, category: "PDF", status: "working", notes: "Decrypts Convertify-protected PDFs. Also handles standard PDFs." },
  { name: "Sign PDF", slug: "sign-pdf", icon: Pen, category: "PDF", status: "working", notes: "Draw, upload, or type signatures. Exports all pages with overlay." },
  { name: "Image to PDF", slug: "image-to-pdf", icon: FileUp, category: "PDF", status: "working", notes: "Multiple image upload with reorder. Supports JPG, PNG, WebP." },
  ...
  { name: "AVIF to JPG", slug: "avif-to-jpg", icon: Image, category: "Image", status: "limited", notes: "Depends on browser AVIF support. Works in Chrome/Edge." },
  { name: "HEIC to JPG", slug: "heic-to-jpg", icon: Image, category: "Image", status: "limited", notes: "Uses heic2any library. Processing may be slow for large files." },
  { name: "Resize Image", slug: "resize-image", icon: Shrink, category: "Image", status: "working", notes: "Custom width/height via Canvas API." },
  { name: "Compress Image", slug: "compress-image", icon: Archive, category: "Image", status: "working", notes: "Quality-based JPEG compression (40%/60%/80%)." },
  { name: "Rotate Image", slug: "rotate-image", icon: RotateCw, category: "Image", status: "working", notes: "Live preview with slider. Downloads properly rotated PNG." },
...
const ToolStatusPage = () => {
  ...
  return (
    <>
      <SEO title="Tool Status" description="Check the real-time status of all Convertify tools — see which tools are working, limited, or need attention." path="/tool-status" noindex />
      <Navbar />
      <div className="min-h-screen pt-28 pb-20">
        <div className="container max-w-4xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="text-muted-foreground text-center mb-8">Real-time status of all Convertify tools.</p>
